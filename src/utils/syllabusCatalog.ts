...
Squire & Alvarez — Retrograde Amnesia and Memory Consolidation`
  },
  {
    ...
    courseName: 'Critical Perspectives on Human Sexuality & Society',
    instructorName: 'Faculty of Socio-Cultural & Gender Studies',
    instructorEmail: 'genderstudies@research-initiative.edu',
    department: 'Interdisciplinary Research Initiative & Curricular Dossier',
    fileName: 'PRJ_SEX_2026_Human_Sexuality_Syllabus.pdf',
    fileSize: '286 KB',
    hexColor: '#D94033',
    rawText: 'INTERDISCIPLINARY RESEARCH INITIATIVE & CURRICULAR DOSSIER\nCritical Perspectives on Human Sexuality &\nSociety\nProgram: Socio-Cultural & Gender Studies\nFramework\nArchival Reference: PRJ-SEX-2026-\nX\nStatus: Active Research &\nSyllabi\n1. THEORETICAL FOUNDATION & EPISTEMOLOGICAL FRAMEWORK\nThe systematic examination of human sexuality within contemporary humanities and social sciences departs from biological\ndeterminism, recognizing sexual desires, identities, moralities, and relationship conventions as deeply cultural, historically\ncontingent, and politically mediated phenomena. Rather than treating sexuality as an immutable biological drive, rigorous\nsocial inquiry analyzes how linguistic systems, legal architectures, and institutional powers categorize erotic experiences. In\nWestern intellectual history, the transformation of intimate conduct into fixed identity categories reflects evolving regimes of\nknowledge and discipline.\nBy interrogating the discourses surrounding bodily autonomy, gender norms, and social scripts, researchers trace how\nnormative categories establish criteria for belonging and deviance. Theoretical contributions from structuralism, post-\nstructuralism, and queer theory illustrate that what cultures deem "natural" or "unnatural" represents a codified distribution of\nsocial authority. This curricular project investigates these shifting terrains through exhaustive readings and structured student\nassignments.\n2. CURRICULUM MATRIX: WEEKS 1–2 (READINGS & APPLIED\nFIELDWORK)\nREADING 01: Foundational Discourse Week 1\nFoucault, M. | The History of Sexuality, Vol. 1: An Introduction |\nCh. 1 & 2 (pp. 15–49)\nExamines the repressive hypothesis, the explosion of\ndiscourses around sexuality since the eighteenth century, and\nthe institutional deployment of power-knowledge across\nchurch, clinic, and state apparatuses.\nASSIGNMENT 01: Discursive Field\nMapping\nDue: Week\n1\nDeliverable: 1,500-word Critical Memo & Textual Deconstruction\nAnalyze a contemporary regulatory, medical, or media text\naddressing adolescent or public sexual health. Map how\nlanguage constructs authority and define the implicit power-\nknowledge matrix operating within the document.\nREADING 02: Social Constructionism Week 2\nVance, C. S. | Pleasure and Danger: Exploring Female Sexuality\n| Ch. 1: "More Danger, More Pleasure"\nArticulates the tension between vulnerability, legal risk, and\nautonomous erotic expression for women, framing sexual\npolitics through intersectional socio-legal constraints.\nASSIGNMENT 02: Policy Dilemma Case\nAnalysis\nDue: Week\n2\nDeliverable: 1,200-word Comparative Review & Annotated Chart\nSelect two municipal or university intimacy/safety policies.\nEvaluate how they negotiate the balance between protection\nagainst harm and the promotion of consensual individual\nagency and autonomy.\nThrough these foundational materials, researchers cultivate the analytical tools necessary to interrogate institutional claims of\nobjective sexual standards, setting the stage for subsequent historical investigations.\nDossier: Sexuality, Culture, and Society Syllabus & Archival Protocol Page 1 of 5\nHISTORICAL RECONSTRUCTIONS & INSTITUTIONAL POWER\nGenealogies of Sexual Categorization\nUnit II: Historical Evolution & Medicalization Modules: 3 & 4\n3. THE INVENTION OF PATHOLOGY AND THE MEDICAL GAZE\nDuring the nineteenth and twentieth centuries, European and North American psychiatric institutions increasingly classified\nsexual practices that deviated from procreative marital frameworks as psychiatric pathologies. The transition from\necclesiastical condemnation (sin) to clinical diagnosis (deviance or perversion) transformed moral judgment into scientific\ntaxonomy. Historians of medicine demonstrate how the diagnostic criteria for conditions such as hysteria, inversion, and\nparaphilias mirrored Victorian bourgeois anxieties regarding industrialization, gender roles, and demographic management.\nThe taxonomy of sexual variation served not only to pathologize non-normative individuals but also to delineate the\nboundaries of respectable citizenship. This medicalization facilitated state surveillance and intervention under the banner of\npublic hygiene. Understanding this historical arc is paramount for deconstructing contemporary health rhetoric and legal\nframeworks governing bodily expression.\n4. CURRICULUM MATRIX: WEEKS 3–4 (READINGS & APPLIED\nFIELDWORK)\nREADING 03: The Invention of HeterosexualityWeek 3\nKatz, J. N. | The Invention of Heterosexuality | Ch. 2 & 3:\n"Medicalization and Early Norms"\nDemonstrates how "heterosexuality" emerged historically as a\nspecialized psychiatric term before transforming into the\nassumed universal baseline of natural human attraction.\nASSIGNMENT 03: Historical Lexicon\nArchival Audit\nDue:\nWeek 3\nDeliverable: Primary Source Primary Dossier & Etymological\nTimeline\nExamine late 19th-century medical journal entries or legal\nbriefs. Trace the shifts in diagnostic vocabulary regarding\nromantic affection, documenting when terminology\ntransitioned into popular vernacular.\nREADING 04: The Kinsey Paradigm &\nContinuum\nWeek\n4\nKinsey, A. et al. | Sexual Behavior in the Human Male & Female |\nSelected Excerpts on the Kinsey Scale\nInvestigates empirical methodologies that challenged binary\ncategorizations of desire, introducing quantitative scalar\nmodels to capture variance across diverse populations.\nASSIGNMENT 04: Survey Methodology\nEvaluation\nDue:\nWeek 4\nDeliverable: 1,500-word Methodological Critique & Revised\nSurvey Tool\nCritique Kinsey\'s sampling biases and interview protocols.\nDesign an updated, non-stigmatizing quantitative\nquestionnaire measuring modern multidimensional attractions\nand romantic self-identifications.\nStudents synthesize these readings to comprehend how historical taxonomies continue to inform legal entitlements, family\nlaw definitions, and therapeutic assumptions in the contemporary era.\nDossier: Sexuality, Culture, and Society Syllabus & Archival Protocol Page 2 of 5\nINTERSECTIONALITY, RACE & POSTCOLONIAL CRITIQUES\nIntersecting Systems: Race, Class, and Desire\nUnit III: Critical Race Theory & Postcolonial Geographies Modules: 5 & 6\n5. DECENTERING THE WESTERN METRONORMATIVE PERSPECTIVE\nThe social organization of sexuality cannot be understood in isolation from racial capitalism, imperial conquests, and class\nhierarchies. Black feminist thought and subaltern studies illuminate how racialized bodies have historically been subjected to\nhypersexualization, labor exploitation, and disenfranchisement. The imposition of European heteronormative family\nstructures frequently dismantled preexisting indigenous systems of gender and erotic plurality across the global South.\nContemporary scholarship emphasizes the concept of "metronormativity"—the assumption that authentic sexual liberation\nrequires migration from rural or non-Western spaces to secular Western metropolitan centers. Dismantling this presumption\nallows researchers to appreciate diverse vernacular expressions of desire, kinship, and community survival that refuse\nWestern categorical definitions.\n6. CURRICULUM MATRIX: WEEKS 5–6 (READINGS & APPLIED\nFIELDWORK)\nREADING 05: Black Feminist Erotic Thought Week 5\nLorde, A. | Sister Outsider: Essays and Speeches | "Uses of the\nErotic: The Erotic as Power"\nReframes the erotic not merely as sensationalized sexual\nperformance, but as a deeply rooted source of creative energy,\ninner validation, and resilience against systemic oppression.\nASSIGNMENT 05: Autoethnographic\nSynthesis\nDue: Week\n5\nDeliverable: 1,500-word Reflective Autoethnography on Erotic\nPower\nReflect on Lorde’s thesis regarding the suppression of feeling\nwithin hyper-rationalized systems. Formulate a personal or\ncommunal case study examining how creative joy counters\nstructural alienation.\nREADING 06: Decolonial Queerness Week 6\nLugones, M. | Hypatia | "Heterosexualism and the Colonial /\nModern Gender System" (Vol. 22)\nTheorizes how European colonization violently instituted\nbinary gender roles and enforced nuclear patriarchal\narrangements upon communal, non-binary indigenous\ncivilizations.\nASSIGNMENT 06: Global Legal\nComparative Dossier\nDue:\nWeek 6\nDeliverable: Comparative Legal Policy Matrix & 1,000-word\nSynthesis\nSelect two postcolonial nation-states. Trace the legacy of\nBritish colonial penal codes (e.g., historical Section 377\nstatutes) and evaluate modern local grassroots strategies for\ndecriminalization and human rights advocacy.\nBy challenging monolithic Western narratives, students develop cultural humility and analytical depth when examining\nintersectional expressions of identity across geopolitical boundaries.\nDossier: Sexuality, Culture, and Society Syllabus & Archival Protocol Page 3 of 5\nQUEER THEORY, PERFORMATIVITY & TECHNOLOGY\nSubversions, Technologies, and Embodiment\nUnit IV: Performativity, Digital Spaces, & Biopolitics Modules: 7 & 8\n7. PERFORMATIVITY, ALGORITHMIC DESIRES, AND DIGITAL MEDIATION\nJudith Butler’s theory of gender performativity disrupted the concept of an essential core identity, positing that gender and\nsexual roles are instituted through stylized, repetitive bodily acts. This framework underscores that bodily identities are not\ngiven by nature, but generated through sustained cultural repetition. Concurrently, the 21st century has witnessed an\nunprecedented migration of sexual sociality, dating, and identity formulation into digital spaces.\nGeolocation algorithms, dating platforms, and content filtering systems now actively curate and discipline desires. Platform\ninterfaces construct choice architectures that incentivize specific body aesthetics, commercialize intimacy, and categorize\ndemographics according to commercial imperatives. As artificial intelligence and biometrics increasingly mediate human\nencounters, researchers confront novel iterations of surveillance, commodification, and relational connection.\n8. CURRICULUM MATRIX: WEEKS 7–8 (READINGS & APPLIED\nFIELDWORK)\nREADING 07: Gender Performativity & Drag Week 7\nButler, J. | Gender Trouble: Feminism and the Subversion of\nIdentity | Ch. 3: "Bodily Inscriptions"\nExamines how parodic repetition and subversive bodily\npractices reveal the imitative and constructed status of\nnaturalized heteronormative gender arrangements.\nASSIGNMENT 07: Semiotic Media\nAnalysis\nDue: Week\n7\nDeliverable: 1,500-word Semiotic Breakdown of Pop Culture\nArtifacts\nSelect a viral media campaign, theatrical performance, or film.\nAnalyze how clothing, voice modulation, and gesture enact or\ndismantle compulsory heteronormative codes.\nREADING 08: Algorithmic Intimacy &\nPlatforms\nWeek\n8\nMowlaboccus, S. | Digital Sexualities: Social Relations and\nDigital Space | Ch. 4: "App Culture and Space"\nAnalyzes how dating applications reshape urban geographies,\nbodily expectations, and sexual scripts, transforming\nserendipitous community spaces into data-driven digital\nexchanges.\nASSIGNMENT 08: UX & Algorithmic\nArchitecture Audit\nDue:\nWeek 8\nDeliverable: Interface Design Teardown & Ethical Blueprint\n(1,200 words)\nConduct an algorithmic and UI audit of an active dating\napplication. Identify how filtering systems, monetization\nfunnels, and badge identifiers privilege certain bodies while\nexcluding marginalized users.\nThis intersection between classic queer theory and algorithmic sociology equips scholars to comprehend 21st-century\ntransformations of courtship, identity creation, and bodily autonomy.\nDossier: Sexuality, Culture, and Society Syllabus & Archival Protocol Page 4 of 5\nPUBLIC HEALTH, LAW & PEDAGOGICAL CAPSTONE\nCommunity Resilience, Law, and Final Synthesis\nUnit V: Biopolitics, Health Equity, & Capstone Modules: 9 & 10\n9. PUBLIC HEALTH, MORAL PANICS, AND LEGAL CODIFICATION\nThe social trajectory of human sexuality is fundamentally bound to legal statutes and public health emergencies. From the\nAIDS epidemic of the 1980s to contemporary controversies regarding comprehensive sex education, reproductive\ntechnologies, and gender-affirming medical care, intimate choices reside at the center of legislative contention. Moral panics\nfrequently utilize the rhetoric of collective protection to justify punitive censorship and discriminatory zoning practices.\nScholarly rigor requires parsing how empirical epidemiological science conflicts with ideologically motivated policy\ninterventions. Grassroots mutual aid and community coalitions consistently emerge in response to institutional negligence,\ndemonstrating the resilient capacities of marginalized sexual cultures to cultivate their own survival mechanisms, healthcare\naccess, and political agency.\n10. CURRICULUM MATRIX: WEEKS 9–10 & CAPSTONE REQUIREMENTS\nREADING 09: Moral Panics & Hierarchies Week 9\nRubin, G. | Pleasure and Danger | "Thinking Sex: Notes for a\nRadical Theory of the Politics of Sexuality"\nIntroduces the "charmed circle" of sexual acceptability versus\nthe outer limits of social condemnation, demonstrating how\nstates arbitrate moral boundaries.\nASSIGNMENT 09: Legislative Discourse\nPolicy Brief\nDue:\nWeek 9\nDeliverable: 1,500-word Legislative Brief on Contested\nLegislation\nDraft a policy brief analyzing a current municipal, state, or\nfederal bill concerning sex education, bodily autonomy, or\npublic performances. Detail stakeholder positions and civil\nrights impacts.\nREADING 10: Biopolitics, AIDS & ActivismWeek 10\nCrimp, D. | AIDS: Cultural Analysis/Cultural Activism | "Mourning\nand Militancy" (MIT Press)\nSynthesizes grassroots direct action (ACT UP) with\npsychoanalytic grief, illustrating how medical crises mobilize\ncollective political resistance against bureaucratic apathy.\nASSIGNMENT 10: Culminating Capstone\nResearch Proposal\nDue:\nWeek 10\nDeliverable: 3,000-word Integrated Research Thesis & Ethics\nProtocol\nFormulate a comprehensive research design integrating at least\nfive course authors, detailing primary archival or ethnographic\nmethods, ethical considerations, and socio-legal implications.\nMODULE CORE THEORETICAL\nFOCUS REQUIRED READING CHAPTER APPLIED ASSIGNMENT TARGET\n01 – 02 Discursive Regimes & Pleasure Foucault (Ch. 1-2); Vance (Ch. 1) Discourse Mapping & Policy Review\n03 – 04 Medicalization & Scalar\nVariance\nKatz (Ch. 2-3); Kinsey (Scale Excerpts) Lexicon Audit & Survey Redesign\n05 – 06 Intersectionality &\nDecoloniality\nLorde (Uses of Erotic); Lugones\n(Hypatia)\nAutoethnography & Global Legal\nDossier\n07 – 08 Performativity & Platforms Butler (Ch. 3); Mowlaboccus (Ch. 4) Semiotic Analysis & App UI Audit\n09 – 10 Moral Panics & Biopolitical\nCrisis\nRubin (Thinking Sex); Crimp\n(Militancy)\nLegislative Brief & Capstone Thesis\nDossier: Sexuality, Culture, and Society Syllabus & Archival Protocol Page 5 of 5'
  },
];
