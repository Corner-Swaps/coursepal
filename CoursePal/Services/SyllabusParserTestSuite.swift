...
public final class SyllabusParserTestSuite {
    ...
    public func run25QATestSuite() -> [TestResult] {
        ...
        // Test 24: Title Preservation (Chapter 1 — Addressing Sexuality)
        ...
        let pass24 = !title24.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty
        results.append(TestResult(testId: 24, testName: "Title Preservation: Chapter 1 Full Title", passed: pass24, details: pass24 ? "Clean Title: '\(title24)'" : "Failed."))

        // Test 25: Title Preservation (Group Sexuality Research Paper 40%)
    ...
    /// Executes the 10-Round Live Gemini QA Battery
    public func run10RoundLiveGeminiQABattery() async -> [TestResult] {
        var results: [TestResult] = []
        let testSyllabiDir: String = {
            let possiblePaths = [
                "/Users/slava/Downloads/Projects/ClassPal/test_syllabi",
                "/Users/slava/Downloads/Projects/CoursePal/test_syllabi",
                "./test_syllabi",
                "../test_syllabi"
            ]
            ...
            return "/Users/slava/Downloads/Projects/ClassPal/test_syllabi"
        }()
        let pdfNames = [
